...
from ..controllers.list_controller import get_lists_by_board, create_list, delete_list, update_list
...
@list_bp.route('/<int:board_id>/lists/<int:list_id>', methods=['PUT'])
@jwt_required()
def handle_update_list(board_id, list_id):
    return update_list(board_id, list_id)
